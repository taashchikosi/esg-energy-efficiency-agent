...
# Page Tabs
# -----------------------------
tab_ml, tab_rag = st.tabs(["⚡ ML Predictor", "📚 Ask the Knowledge Base (RAG)"])


# -----------------------------
# TAB 1: ML Predictor (your existing app)
# -----------------------------
with tab_ml:
...
# -----------------------------
with tab_rag:
    st.title("📚 Ask the Knowledge Base (RAG)")
    ...
    if not RAG_READY:
        st.warning(
            ...
            "2) Ensure rag_project/vector_store exists in this repo"
        )
        st.stop()
